...
the Avatar Root configuration while leaving existing Scene/Prefab assets untouched;
Scene apply remains the explicit alternative before Scene Preview checks the lilToon package automatically.
